<?php
/*
 Plugin Name: Image Archives TEST
...
function wp_image_archives_test( $args = '' ) {
...
$image_archives_test = new image_archives_test();
add_shortcode( 'image_archives_test', array ( $image_archives_test, 'image_archives_shortcode' ));
